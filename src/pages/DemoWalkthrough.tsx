        ...
        <main style={{ flex: 1, padding: '2rem', position: 'relative', overflow: 'hidden' }}>
          ...
          {step === 0 && (
            <div>
              ...
              <Tooltip title="Your Inventory Dashboard" desc="All your items in one place. See status, cost-per-use, and quick-edit prices directly on each card — no need to open an item to update it." onNext={nextStep} />
            </div>
          )}
          ...
          {step === 3 && (
            <div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '1.5rem', marginBottom: '2rem' }}>
                {[
                  { label: 'Total Inventory Value', value: '$562', color: 'var(--accent-primary)' },
